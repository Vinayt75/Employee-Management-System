...
def search_employee():
    if searchEntry.get()=='':
        messagebox.showerror('Error','Entry value to search')
...
#GUI part
window=CTk()
window.geometry('1129x650+100+100')
window.resizable(0,0)
window.title('Employee Management System')
window.configure(fg_color='#161C30')
logo=CTkImage(Image.open('m.jpg'),size=(1129
                                            ,150))
...
role_options=['Web Developer','Technical Write','Network Engineer','Data Scientist','Business Analyst']
...
searchButton=CTkButton(rightFrame,text='Search',width=150,command=search_employee)
searchButton.grid(row=0,column=2)

showallButton=CTkButton(rightFrame,text='Show All',width=150,command=show_all)
...
newButton=CTkButton(buttonFrame,text='New Employee',font=('arial',15,'bold'),width=200,corner_radius=15,command=lambda:clear(True))
newButton.grid(row=0,column=0,pady=5)

addButton=CTkButton(buttonFrame,text='Add Employee',font=('arial',15,'bold'),width=200,corner_radius=15,command=add_employee)
addButton.grid(row=0,column=1,pady=5,padx=5)

updateButton=CTkButton(buttonFrame,text='Update Employee',font=('arial',15,'bold'),width=200,corner_radius=15,command=update_employee)
updateButton.grid(row=0,column=2,pady=5,padx=5)

deleteButton=CTkButton(buttonFrame,text='Delete Employee',font=('arial',15,'bold'),width=200,corner_radius=15,command=delete_employee)
deleteButton.grid(row=0,column=3,pady=5,padx=5)

deleteallButton=CTkButton(buttonFrame,text='Delete All',font=('arial',15,'bold'),width=200,corner_radius=15,command=delete_all)
